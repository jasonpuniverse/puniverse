      ...
      <Reveal>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="relative group lg:sticky top-32">
            ...
            <div className="relative rounded-3xl overflow-hidden border border-white/10 aspect-[4/5] bg-white/5">
              <img 
            ...
            <div className="lg:hidden mt-8">
               <div className="flex items-end gap-4 mb-4">
                  ...
                  <span className="text-gray-500 text-xs pb-1 uppercase tracking-wider">One-time payment</span>
                </div>
          ...
          <div className="space-y-12">
                ...
                <div className="space-y-4 pl-1">
                  {product.howItWorks.map((step, idx) => (
                    <div key={idx} className="flex items-start gap-4 text-gray-300">
                      <div className="w-6 h-6 rounded-full bg-white/5 flex flex-col items-center justify-center shrink-0 border border-white/10 mt-0.5 shadow-lg shadow-black/20">
              ...
              <div className="space-y-4">
                ...
                <ul className="list-none space-y-2 pl-2">
                   {product.setupSteps.map((step, idx) => (
                      <li key={idx} className="flex items-center gap-2 text-gray-400 before:content-[''] before:block before:w-1.5 before:h-1.5 before:rounded-full before:bg-teal-500/50">
                        {step}
                      </li>
                   ))}
                </ul>
            ...
            <div className="pt-6 hidden lg:block">
              <div className="flex items-end gap-4 mb-6">
                ...
                <span className="text-gray-500 text-sm pb-2 uppercase tracking-wider">One-time payment</span>
              </div>
              ...
              <p className="text-center text-xs text-gray-500 mt-4 flex items-center justify-center gap-2 border border-white/5 bg-black/20 p-2 rounded-lg">
