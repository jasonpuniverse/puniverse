        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <Reveal>
            <div>
              ...
              <h2 className="text-3xl font-bold text-[var(--color-text-primary)] mb-6">Everything you need to build your own AI OS.</h2>
          ...
          <Reveal delay={0.2}>
            <div className="rounded-2xl border border-purple-500/30 bg-purple-500/5 p-8 relative overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-xs text-[var(--color-text-tertiary)]">Includes all workflows, agents, and community access.</p>
              </div>
            </div>
          </Reveal>
        </div>
        ...
        <StaggerReveal className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <StaggerItem>
            <GlassCard className="text-center h-full">
              ...
              <h3 className="text-lg font-medium text-[var(--color-text-primary)] mb-2">Founders</h3>
              <p className="text-sm text-[var(--color-text-secondary)]">Looking to scale their ecommerce brand without hiring a massive team.</p>
            </GlassCard>
          </StaggerItem>
          <StaggerItem>
            <GlassCard className="text-center h-full">
              <MessageSquare className="text-blue-400 mx-auto mb-4" size={24} />
              <h3 className="text-lg font-medium text-[var(--color-text-primary)] mb-2">Builders</h3>
              <p className="text-sm text-[var(--color-text-secondary)]">Wanting to learn how to connect AI agents and automation pipelines.</p>
            </GlassCard>
          </StaggerItem>
          <StaggerItem>
            <GlassCard className="text-center h-full">
              <Users className="text-purple-400 mx-auto mb-4" size={24} />
              <h3 className="text-lg font-medium text-[var(--color-text-primary)] mb-2">Operators</h3>
              <p className="text-sm text-[var(--color-text-secondary)]">Seeking to replace manual, repetitive tasks with autonomous systems.</p>
            </GlassCard>
          </StaggerItem>
        </StaggerReveal>
      </section>
